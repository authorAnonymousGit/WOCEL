...
class ConfigMain:
    ...
    # AMAZON_DATASETS = ['AmazonFashion', 'AmazonAll_Beauty', 'AmazonSoftware']
    ...
    TEXT_FEATURE = 'text'
    MODEL_NAME = 'FCBERT'
    EMBEDDINGS_VERSION = 'distilbert-base-uncased'  # "bert-base-uncased"/"bert-large-uncased"/"roberta-base"/"albert-large-v2"/"distilbert-base-uncased"
    EMBEDDINGS_PATH = 'distilbert-base-uncased'  # "bert-base-uncased"/"bert-large-uncased"/"roberta-base"/"albert-large-v2"/"distilbert-base-uncased"
...
class ConfigPrimary:
    ...
    ALPHA = np.linspace(0.5, 0.9, 5)  # Irrelevant
